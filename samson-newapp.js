...
.to(".close", {autoAlpha:0}, "<")
  ...
  .to(".fadein", {y: -20, autoAlpha: 0, duration: 0.2}, "<0.1")
  .to(slide, {duration: 0.65,transformOrigin: "top center", scaleY: 0, ease: "Expo.inOut"}, "<0.6")
...
function projectsHeroAnima() {
  ...
  //.set(".hide", {autoAlpha:1})
  .from(".char", {stagger:0.02, yPercent:180})
  .fromTo(".fadein", {autoAlpha:0, y:40},{duration:0.4, autoAlpha:1, stagger:0.05, y:0}, "<0.1")
