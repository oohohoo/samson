...
.fromTo(".menufade", {y: 20, autoAlpha: 0}, {duration: 0.65, y: 0, stagger: 0.02, autoAlpha: 1, ease: "Expo.inOut"}, "<0.4")
...
.to(".menufade", {y: -20, autoAlpha: 0, duration: 0.35, ease: "Expo.inOut"}, "<0.2")
...
.to(".close", {autoAlpha:0}, "<")
  ...
  .to(".menufade", {y: -20, autoAlpha: 0, duration: 0.3}, "<0.2")
