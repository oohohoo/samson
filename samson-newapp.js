...
function projectsHeroAnima() {
  ...
  //.set(".hide", {autoAlpha:1})
  .from(".char", {stagger:0.02, yPercent:125})
  .fromTo(".in1", {autoAlpha:0, y:40},{autoAlpha:1, y:0}, "<0.1")
  .fromTo(".in2", {autoAlpha:0, y:40},{autoAlpha:1, stagger:0.2, y:0}, "<0.2")
 /*  .fromTo(".fadein", {autoAlpha:0, y:40},{duration:0.6, autoAlpha:1, stagger:0.2, y:0}, "<0.1") */
  ...
  {autoAlpha:1, duration:2, y:0, clipPath:"polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)"},"<0.3")
