...
dev.interactions = {
  ...
  filtersOnEnter: function(e) {
    ...
    gsap.to("[data-filters] a", {duration:0.3, color: "#D0D0CE"});
  ...
  filtersOnLeave: function(e) {
    ...
    gsap.to("[data-filters] a", {duration:0.3, color: "#1e1e1e"});
  }
};
 ...
 */
 ...
 .from(".char", {stagger:0.02, yPercent:130, duration:1.3}, "<")
...
function tailoredHeroAnima() {
  ...
  .fromTo(".clip", {y:200, autoAlpha:0, clipPath:"polygon(40% 30%, 60% 30%, 60% 90%, 40% 90%)"}, 
  {autoAlpha:1, duration:2, y:0, clipPath:"polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)"}, "-=1")
...
heroanimation
//.set(".hide", {autoAlpha:1})
.from(".char", {stagger:0.02, duration:1.5,yPercent:125})
...
.fromTo(".c1", {autoAlpha:0, y:40},{duration:0.8, autoAlpha:1, stagger:0.02, y:0}, "<0.6")
